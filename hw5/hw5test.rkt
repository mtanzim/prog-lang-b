...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (mlet "x" (int 1) (mlet "y" (int 100) (add (var "x") (var "y"))) )) (int 101) "nested mlet test")
   ...
   ;;snd test
   (check-equal? (eval-exp (snd (apair (mlet "x" (int 1) (add (int 5) (var "x"))) (int 10)))) (int 10) "snd test")
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "y" (int 11)) (cons "z" (int 12)) ) (var "y"))) (int 11) "mlet* test")
   ;; ifeq test
