...
(define tests
  (test-suite
   ...
   ; list-nth-mod test
    ...
    (check-equal? (list-nth-mod (list 45 56 66 63 2344) 6) 56 "list-nth-mod test")
   ...
   (check-equal? (vector-assoc 2 (vector 2 (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1))) (cons 2 1) "vector-assoc test")
